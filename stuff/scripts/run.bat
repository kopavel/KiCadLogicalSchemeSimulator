...
-m KiCadLogicalSchemeSimulator.simulator/pko.KiCadLogicalSchemeSimulator.Simulator -od=%~dp0optimised -m=%~dp0kicad.sym_map -m=%~dp0chip.sym_map -m=%~dp0retro.sym_map %*
